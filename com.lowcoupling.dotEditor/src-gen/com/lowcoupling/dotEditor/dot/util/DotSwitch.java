...
public class DotSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        UndirectedGraph undirectedGraph = (UndirectedGraph)theEObject;
        T result = caseUndirectedGraph(undirectedGraph);
        if (result == null) result = caseGraph(undirectedGraph);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DotPackage.DIRECTED_GRAPH:
      {
        DirectedGraph directedGraph = (DirectedGraph)theEObject;
        T result = caseDirectedGraph(directedGraph);
        if (result == null) result = caseGraph(directedGraph);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Undirected Graph</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Undirected Graph</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseUndirectedGraph(UndirectedGraph object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseDirectedGraph(DirectedGraph object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Un Directed Edge</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Un Directed Edge</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
